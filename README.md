...
Report X/Imagenes/: Contains all visual aids used in the report.

Report X/codigos/: Holds all source code (VHDL, Verilog, etc.).
...
Navigate to the folder corresponding to the lab practice you are interested in.

The final report can be viewed directly from the PDF file (main.pdf).

All source code and assets are located within their respective subfolders.

⭐ Recommended .gitignore

For LaTeX projects, it's good practice to prevent temporary compilation files from being tracked by Git. Create a .gitignore file in your project's root with the following content:
