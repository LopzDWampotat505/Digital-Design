...
HD_PWD='C:/Users/juanp/OneDrive/Escritorio/Monedas/Monedas.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_mon.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ent_mon.tcl -notrace
