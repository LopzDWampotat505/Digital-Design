...
HD_PWD='C:/Users/juanp/OneDrive/Escritorio/Cisterna/Cisterna.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cis.tcl
