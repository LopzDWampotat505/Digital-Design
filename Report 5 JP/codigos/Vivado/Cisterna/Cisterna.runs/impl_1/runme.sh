...
HD_PWD='C:/Users/juanp/OneDrive/Escritorio/Cisterna/Cisterna.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cis.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cis.tcl -notrace
