...
HD_PWD='C:/Users/183339/Downloads/Half_Substractor/Half_Substractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_half.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ent_half.tcl -notrace
