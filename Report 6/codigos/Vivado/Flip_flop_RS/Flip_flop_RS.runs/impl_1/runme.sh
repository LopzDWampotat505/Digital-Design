...
HD_PWD='C:/Users/183339/Downloads/Flip_flop_RS/Flip_flop_RS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_sync.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sr_sync.tcl -notrace
