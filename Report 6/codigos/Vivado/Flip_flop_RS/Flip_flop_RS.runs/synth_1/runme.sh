...
HD_PWD='C:/Users/183339/Downloads/Flip_flop_RS/Flip_flop_RS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sr_sync.tcl
