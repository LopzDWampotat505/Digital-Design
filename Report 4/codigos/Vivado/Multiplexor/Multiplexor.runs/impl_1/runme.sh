...
HD_PWD='C:/Users/183339/Downloads/Multiplexor/Multiplexor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ent_mult.tcl -notrace
