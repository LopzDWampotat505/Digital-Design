...
HD_PWD='C:/Users/183339/Downloads/Multiplexor/Multiplexor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ent_mult.tcl
