...
HD_PWD='C:/Users/183339/Downloads/Demultiplexor/Demultiplexor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_demult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ent_demult.tcl
