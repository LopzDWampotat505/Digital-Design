...
HD_PWD='C:/Users/183339/Downloads/Demultiplexor/Demultiplexor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_demult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ent_demult.tcl -notrace
