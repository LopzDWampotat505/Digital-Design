...
HD_PWD='C:/Users/juanp/OneDrive/Escritorio/Monedas/Monedas.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ent_mon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ent_mon.tcl
