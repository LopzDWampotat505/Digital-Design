...
HD_PWD='C:/Users/183339/Downloads/Relay_Test/Relay_Test/Relay_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_relays.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_light_relays.tcl
