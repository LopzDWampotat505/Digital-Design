...
HD_PWD='C:/Users/183339/Downloads/Relay_Test/Relay_Test/Relay_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_relays.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_light_relays.tcl -notrace
